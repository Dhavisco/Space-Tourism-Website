      ...
      <div className="hero text-white grid lg:grid-cols-2 gap-20 lg:gap-8 column w-[100%] h-[100vh] px-2 font-sans items-center  content-center md:px-16 lg:px-[8rem]">
        <div className="flex flex-col justify-center mt-[7rem]">
          ...
          <div className="flex flex-col justify-end items-end lg:mt-[14.2rem]">
            <Link to="/destination">
            <div className="flex justify-center items-center tracking-widest leading-relaxed text-xl lg:text-2xl font-[Sans-serif] font-[50] border-b-2 border-blue-900 bg-white text-[#111142c9] rounded-full w-[10rem] h-[10rem] lg:w-[13rem] lg:h-[13rem] uppercase cursor-pointer hover:bg-[#b1b1ee] hover:text-[#111142f1] transition-colors duration-300">
              Explore
            </div>
            </Link>
          </div>
